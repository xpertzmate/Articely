...
const projectURL = 'https://articely.local/';
...
const textDomain = 'Articely';

// Name of the translation file.
const translationFile = 'Articely.pot';

// Where to save the translation files.
const translationDestination = './languages';

// Package name.
const packageName = 'Articely';

// Where can users report bugs.
const bugReport = 'https://articely.com/contact/';

// Last translator Email ID.
const lastTranslator = 'XpertzMate <xpertzmate@gmail.com>';

// Team's Email ID.
const team = 'XpertzMate <xpertzmate@gmail.com>';
