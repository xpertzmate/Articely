...
function articely_scripts()
{
    ...
    wp_enqueue_style('iac-style', get_stylesheet_uri(), array(), wp_get_theme()->get('Version'));
    // wp_enqueue_style('iac-app', ARTICELY_URL . '/assets/css/app.css', array(), strtotime('now'));
